...
def Create_Course():
    ...
    Name = Text(frm_creat1, height = 1, width = 10).grid(column=1, row=1,padx=10, pady=10)
    ttk.Label(frm_creat1, text="Description",background='').grid(column=0, row=2)
    Name = Text(frm_creat1, height = 3, width = 10).grid(column=1, row=2)
    ttk.Label(frm_creat2, text="TNr",background='').grid(column=0, row=5,padx=10, pady=10)
    ID  = Text(frm_creat2,state=DISABLED, height = 1, width = 10).grid(column=1, row=5)
...
def Training_Data():
    ...
    Name = Text(frm_train1, height = 1, width = 10).grid(column=1, row=1,padx=10, pady=10)
    ttk.Label(frm_train1, text="Date",background='').grid(column=0, row=2)
    Name = Text(frm_train1, height = 1, width = 10).grid(column=1, row=2,padx=10, pady=10)
    ttk.Label(frm_train1, text="Start TIme",background='').grid(column=0, row=3)
    Name = Text(frm_train1, height = 1, width = 10).grid(column=1, row=3,padx=10, pady=10)
    ttk.Label(frm_train1, text="End Time",background='').grid(column=0, row=4)
    Name = Text(frm_train1, height = 1, width = 10).grid(column=1, row=4)
    ttk.Label(frm_train2, text="Course (TNr)",background='').grid(column=0, row=5,padx=10, pady=10)
    ID  = Text(frm_train2,state=DISABLED, height = 1, width = 10).grid(column=1, row=5)
